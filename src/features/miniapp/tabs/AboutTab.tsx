  ...
  return (
    <div className="screen">
      <div className="screen__header">
        <div>
          <div className="screen__title">Обо мне</div>
          <div className="screen__subtitle">
            Заполни анкету и тесты — так рекомендации и совпадения будут точнее.
          </div>
        </div>
        <button
          type="button"
                ...
                <div className="photoRow__avatar">
                  ...
                  {editingProfile && (
                    <div className="photoRow__actions">
                      <label htmlFor="about-photo" className="iosButton iosButton--tiny iosButton--ghost">
